...
[![Google Gemini](https://img.shields.io/badge/Google%20Gemini-black?logo=googlegemini&style=for-the-badge)](#)
  ...
  <p align="center">
    ...
    .
    <a href="https://github.com/05Ashish/supasketch/issues">Report Bug</a>
    .
    <a href="https://github.com/05Ashish/supasketch/issues">Request Feature</a>
  </p>
</p>
...
**SupaSketch** is a multiplayer drawing app powered by **Supabase** and **Gemini AI**. It brings creativity and fun together, allowing users to create rooms, invite friends, and participate in timed drawing challenges. With AI-generated prompts and an AI-powered scoring system, SupaSketch adds a competitive twist to collaborative art. Perfect for friendly competitions, itG��s a playful way to express your artistic side!
...
```bash
git clone https://github.com/05Ashish/supasketch.git
```
...
- **Ashish Negi** - [github.com/05Ashish](https://github.com/05Ashish) - _SupaSketch_
